...
outdir = "/Users/allenma/motif_strand/onesamplep53mufile/"
...
write(line,file=metadatafile,append=TRUE)
proseqfile<-"/scratch/Shares/dowell/dbnascent/out/Allen2014global/bedgraphs/SRR1105739.sorted.bedGraph"
...
col_fun = colorRamp2(quantile(mat0pos, c(0, 0.99)), c("white", "blue"))
...
png(paste(outdir,"mu_near_motifs_centermu_EnrichedHeatmap_of_pro-seq_for_coverage_wdistance.png", sep=""))
